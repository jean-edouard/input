...
#define DRIVER_DESC	"SuperHID USB Host+Gadget Emulator"
#define DRIVER_VERSION	"18 Dec 2014"

#define POWER_BUDGET	500	/* in mA; use 8 for low-power port testing */

static const char	driver_name[] = "superhid_vhcd";
static const char	driver_desc[] = "SuperHID USB Host+Gadget Emulator";

static const char	gadget_name[] = "superhid_vudc";

MODULE_DESCRIPTION(DRIVER_DESC);
MODULE_AUTHOR("Jed Lejosne");
MODULE_LICENSE("GPL");
